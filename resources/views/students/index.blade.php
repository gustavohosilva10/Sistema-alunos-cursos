                                ...
                                <tbody>
                                    @foreach ($student as $student)
                                            ...
                                            <td class="align-middle">
                                                ...
                                                <a href="/students/show{{$student->id}}" data-toggle="tooltip" data-placement="bottom" title="Ver contato">
                                                    <i class="fas fa-caret-square-right text-success" style="font-size:1.5em"></i>
                                                </a>
                                                <a href="/students/edit{{$student->id}}" data-toggle="tooltip" data-placement="bottom" title="Editar contato">
                                                    <i class="fas fa-pen-square text-warning" style="font-size:1.5em"></i>
                                                </a>
                                                <a href="/students/delete/{{$student->id}}" data-toggle="tooltip" data-placement="bottom" title="Excluir contato">
